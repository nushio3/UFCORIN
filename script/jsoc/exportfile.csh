...
set ds=`/home/nushio/hub/UFCORIN/script/jsoc/url_escape.pl "$1"`
...
set notify = `/home/nushio/hub/UFCORIN/script/jsoc/url_escape.pl "$2"`
...
set ffmt = `/home/nushio/hub/UFCORIN/script/jsoc/url_escape.pl '{seriesname}.{T_REC:A}.{segment}'`
...
while ($count > 0)
  ...
  set OFN = `/home/nushio/hub/UFCORIN/script/jsoc/url_escape.pl "$QUERY"`
